      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold font-heading mb-3">Why V-TEKI Center of Excellence?</h2>
          ...
          <div className="bg-gradient-to-br from-primary to-primary/90 rounded-3xl p-10 lg:p-16 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-primary-foreground/70 mb-8 max-w-md mx-auto">
                Join professionals and institutions building practical capability with V-TEKI Center of Excellence.
              </p>
