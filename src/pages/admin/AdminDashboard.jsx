...
export default function AdminDashboard() {
  ...
  const { data: payments = [] } = useQuery({ queryKey: ['payments'], queryFn: () => appClient.entities.Payment.list() });
  const { data: certificates = [] } = useQuery({ queryKey: ['certificates'], queryFn: () => appClient.entities.Certificate.list() });
  ...
  return (
    <div>
      <PageHeader title="Dashboard" subtitle="Overview of your Center of Excellence operations" />
