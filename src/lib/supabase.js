/**
 * Purpose: Initialize and export the Supabase client for the V-TEKI application.
 * Used by: Auth context, API client, and any component needing direct Supabase access.
 * Main dependencies: @supabase/supabase-js, environment variables.
 * Public/main functions: `supabase` client instance.
 * Important side effects: Creates a singleton Supabase client on module load only when explicitly enabled.
 */
